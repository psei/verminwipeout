...
package lang{
	...
	import flash.events.*;
	import flash.text.*;
	public class english extends MovieClip {
		public var myroot:MovieClip;
			...
			// NOVA 
			public var t_3_1:String="CRITTER INVESTATION \n \nThe surface of Balrog VII in the Vendi System is about to be colonized for ore mining. Unfortunately, the toxines in its atmosphere provide a perfect environment for mutant species, which emerged when the planet was considered meaningless and used as a giant galactic trash dump by 326 different worlds. Handsome payments for any merc to do the run, pay per kill. \n \n \nPERSONAL LOG ENTRY \n \ngave up mining station, indebted - 5p1n35n4p - about to be colonized mining - newly arriving colonists pay for someone to clear a certain area of a vermin threat (contractor = SORDID corp) - no technological civilisation other than yourself exists on 5p1n35n4p - first run as one of the famed _slimer mercs_ - Mungoland console readout: 5p1n35n4p, M-class planet, 87% water, 12% landmass, 01% other, partly radioactive - procede with extreme caution massive threats through hostile -Mungo- critters;"
			//ARACHNA
		...
		public function english(root_p:MovieClip) {
			this.myroot=root_p;
		}
	}
}