...
function Player(game, lifeCounter) {
  ...
  function fireWeapon() {
    ...
    if (fireButton.isDown || fireButton2.isDown || game.input.activePointer.leftButton.isDown || isPermanentFire) {
      player.weapon.fire();
    }
  }
  ...
  const fireButton2 = game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
